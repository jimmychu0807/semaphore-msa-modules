export function Instructions() {
  return (
    <div className="grid grid-cols-2 grid-rows-[1fr_auto] text-sm gap-2">
      <div>
        <div className="text-center py-2">Owner Flow</div>
      ...
      <div>
        <div className="text-center py-2">Member Flow</div>
        <ol className="list-decimal pl-6">
